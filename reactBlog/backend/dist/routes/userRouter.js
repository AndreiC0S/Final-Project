...
userRouter.post("/", jsonParser, [
    (0, check_1.check)('nume', 'Name is requied').not().isEmpty(),
    (0, check_1.check)('prenume', 'Name is requied').not().isEmpty(),
    (0, check_1.check)('email', 'Please include a valid email').isEmail().normalizeEmail({ gmail_remove_dots: true }),
    (0, check_1.check)('parola', 'Password must be 8 or more characters').matches(/^(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[!@#$%^&*])(?=.{8,})/, "i")
