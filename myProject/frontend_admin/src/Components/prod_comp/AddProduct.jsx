      ...
      >
        {({ errors, touched }) => (
          <Form className="text-center">
            <Field name="nume_produs" onChange={handleInputChange} placeholder ="      nume produs" className="flex mb-[7px] border-2 border-black rounded-s"/> 
            {errors.nume_produs && touched.nume_produs ? (
              <div className="mb-[10px]">{errors.nume_produs}</div>
            ) : null}

            <Field as="textarea" name="descriere_produs" onChange={handleInputChange}  placeholder ="      descriere produs" className="flex mb-[8px] h-[20vh] w-[100%] border-2 border-black rounded-s"/> 
            {/* {errors.descriere_produs && touched.descriere_produs ? (
              <div className="mb-[10px]">{errors.descriere_produs}</div>
            ) : null} */}

            <Field name="poza_url" onChange={handleInputChange} placeholder="      poza url" className="flex mb-[8px] border-2 border-black"/> 
            {/* {errors.poza_url && touched.poza_url ? <div className="mb-[10px]">{errors.poza_url}</div> : null} */}

            <Field name="categorie_produs" onChange={handleInputChange} placeholder ="     categorie_produs" className="flex mb-[8px] border-2 border-black rounded-s"/> 
            {/* {errors.categorie_produs && touched.categorie_produs ? (
              <div className=" mb-[10px]">{errors.categorie_produs}</div>
            ) : null} */}

            <Field name="pret_produs" onChange={handleInputChange} placeholder="     pret produs" className="flex mb-[8px] border-2 border-black rounded-s"/> 
