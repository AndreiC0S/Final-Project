...
productRouter.get("/", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    productModel.findAllP((err, product) => {
        if (err) {
...
productRouter.get("/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    productModel.findOneP(productId, (err, product) => {
        if (err) {
...
productRouter.post("/", jsonParser, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    console.log(req.body);
    const newProd = req.body;
    productModel.createP(newProd, (err, productId) => {
        if (err) {
            return res.status(500).json({ "message": err.message });
        }
